    ...
    <div id="About">
      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <ul className="para" style={{ color: "white" }}>
            <li>
              Hi! I'm Sanjay Bhandari, Front-End Developer with expertise in
              React and Spring Boot.
            </li>
            <li>
              Passionate about creating seamless user experiences. I bring ideas
              to life through web development, combining innovation with solid
